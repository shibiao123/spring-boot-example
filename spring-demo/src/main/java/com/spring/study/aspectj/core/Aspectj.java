package com.spring.study.aspectj.core;
...
public class Aspectj {
    ...
    //定义切点   (使用注解作为规则)
    @Pointcut("@annotation(com.spring.study.aspectj.newAnnotation.Action)")
    public void annotationPointCut(){}

    //第一个* 表示修饰符 返回值   第一个*和包名之间有一个空格 切记
    //第二个* 表示DemoAnnotaion的所有方法
    //.. 表示任意的参数形式
    @Pointcut("execution(* com.spring.study.aspectj.service.DemoAnnotation.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.spring.study.aspectj.service.DemoAnnotation.test2(..))",throwing = "exceptor")
    ...
    @Around(value="execution(* com.spring.study.aspectj.service.DemoAnnotation.test3(..))")
